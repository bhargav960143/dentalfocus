...
$current_form = $form_id ? ( ( new DentalKit\FormBuilder\FormRepository() )->find( $form_id ) ) : null;
$export_url   = $form_id
...
?>
<div class="wrap">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Submissions', 'dentalkit' ); ?></h1>

	<a href="<?php echo esc_url( $export_url ); ?>" class="page-title-action dk-export-btn">
		<span class="dashicons dashicons-download"></span>
		<?php esc_html_e( 'Export CSV', 'dentalkit' ); ?>
	</a>
	<hr class="wp-header-end">

	<?php if ( isset( $_GET['deleted'] ) ) : ?>
	<div class="notice notice-success is-dismissible">
		<p><?php esc_html_e( 'Submission deleted.', 'dentalkit' ); ?></p>
	</div>
	<?php endif; ?>
	...
	<div class="dk-filter-bar">
		<form method="get">
			...
			<select name="form_id" onchange="this.form.submit()">
				<option value=""><?php esc_html_e( 'All Forms', 'dentalkit' ); ?></option>
	...
	<div class="dk-empty-state">
		...
		<h2><?php esc_html_e( 'No submissions yet', 'dentalkit' ); ?></h2>
		<p><?php esc_html_e( 'When visitors submit your forms, their data will appear here.', 'dentalkit' ); ?></p>
	</div>
	<?php else : ?>
	<table class="wp-list-table widefat fixed striped">
		<thead>
			<tr>
				<th style="width:50px"><?php esc_html_e( 'ID', 'dentalkit' ); ?></th>
				<th><?php esc_html_e( 'Form', 'dentalkit' ); ?></th>
				<th><?php esc_html_e( 'Data Preview', 'dentalkit' ); ?></th>
